<?php
/**
 * Sermon Manager Admin Settings Class
 */
...
if ( ! class_exists( 'SM_Admin_Settings', false ) ) :

/**
 * SM_Admin_Settings Class.
 */
class SM_Admin_Settings {
	...
	public static function get_settings_pages() {
		if ( empty( self::$settings ) ) {
			...
			include_once( dirname( __FILE__ ) . '/settings/class-sm-settings-page.php' );

			$settings[] = include( 'settings/class-sm-settings-general.php' );
			$settings[] = include( 'settings/class-sm-settings-api.php' );
	...
	public static function output() {
		...
		wp_enqueue_script( 'sm_settings', SM()->plugin_url() . '/assets/js/admin/settings' . $suffix . '.js', array( 'jquery', 'jquery-ui-datepicker', 'jquery-ui-sortable', 'iris', 'select2' ), SM()->version, true );
	...
	public static function check_download_folder_protection() {
		...
		$downloads_url   = $upload_dir['basedir'] . '/sm_uploads';
		$download_method = get_option( 'sm_file_download_method' );
