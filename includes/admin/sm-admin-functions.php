<?php
/**
 * Sermon Manager Admin Functions
 *
 * @category Core
 * @package  SermonManager/Admin/Functions
 * @version  3.0.0
 */
 ...
 * @return int page ID
 */
function sm_create_page( $slug, $option = '', $page_title = '', $page_content = '', $post_parent = 0 ) {
	global $wpdb;
	...
	$valid_page_found = apply_filters( 'sm_create_page_id', $valid_page_found, $slug, $page_content );
